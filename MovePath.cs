...
public class MovePath : MonoBehaviour {
    ...
    void Start()
    {
        ...
        if (animName == "walk")
        {
            ...
            {
                animator.speed = moveSpeed * _customWalkAnimationMultiplier;
            }
            else
            {
                animator.speed = moveSpeed * 1.2f;
            }
        }
        else if (animName == "run")
        {
            if (_overrideDefaultAnimationMultiplier)
            {
                animator.speed = moveSpeed * _customRunAnimationMultiplier;
            }
            else
            {
                animator.speed = moveSpeed / 3;
            }
        }
    }
    void Update ()
